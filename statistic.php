...
<!-- Botton bar Statistic START -->
      <div class="btn-toolbar">
          ...
          <div id="blanksArchive" class="multiselect" data-id="<?php echo $periodActual; ?>" data-period="<?php echo $periodInterval; ?>">
            <!-- Basic dropdown -->
                        
<!-- Basic dropdown -->
          </div>
          <select id="fulfilledBlank" class="span2" style="margin-left: 10px; margin-right: 10px;">
          ...
          <?php if (!$isSingleCity) { ?>
          <select id="selStatisticLocality" class="span3">
        ...
        <div class="desctop-visible tablets-visible">
          ...
          <div class="control-group row-fluid">
            <table class="table table-hover">
              <thead>
                <th style="text-align: center; vertical-align: middle"><a id="confirmFulfill">Заполнить из списка</a></th>
                <th style="text-align: center; vertical-align: middle">Меньше 17 лет</th>
                <th style="text-align: center; vertical-align: middle">17-25 лет</th>
                <th style="text-align: center; vertical-align: middle">Старше 25 лет</th>
              ...
              <tbody>
                <tr>
                  ...
                  <td style="text-align: center; vertical-align: middle"><input type="number"  id="bptz17" class="span10" min="0"></td>
                  ...
                  <td style="text-align: center; vertical-align: middle"><input type="number"  id="bptzAll" class="span10" min="0"></td>
                </tr>
                <tr>
                  <td>Посещают собрания</td>
                  <td style="text-align: center; vertical-align: middle"><input type="number" id="attended17" class="span10" min="0"></td>
                  <td style="text-align: center; vertical-align: middle"><input type="number"  id="attended17_25" class="span10" min="0"></td>
                  <td style="text-align: center; vertical-align: middle"><input type="number"  id="attended25" class="span10" min="0"></td>
                  <td style="text-align: center; vertical-align: middle"><input type="number"  id="attendedAll" class="span10" min="0"></td>
                </tr>
                <tr>
                  <td colspan="4" style="text-align: right; vertical-align: middle">В среднем на трапезе</td>
                  <td style="text-align: center; vertical-align: middle"><input data-toggle="tooltip" title="Заполняется вручную!" type="number"  id="ltMeetingAverage" class="span10" min="0"></td>
                </tr>
              </tbody>
            </table>
          </div>
...
var adminLocalityGlb = '<?php echo $adminLocality; ?>';
    ...
    <script src="/js/grid.js?v1"></script>
<?php
