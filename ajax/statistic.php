...
elseif (isset($_GET['set_statistic'])){
    echo json_encode(["statistic"=>db_setNewStatistic($adminId, $_GET['locality'], $_GET['locality_status'], $_GET['period_id'], $_GET['bptz17'], $_GET['bptz17_25'], $_GET['bptz25'], $_GET['bptzAll'], $_GET['attended17'], $_GET['attended17_25'], $_GET['attended25'], $_GET['attendedAll'], $_GET['lt_MeetingAverage'], $_GET['archive'], $_GET['comment'], $_GET['statisticCompleteChkbox'])]);
    exit();
    //$_GET['period_date'],
}
elseif (isset($_GET['update_statistic'])){
    echo json_encode(["statistic"=>db_updateStatistic($adminId, $_GET['locality'], $_GET['locality_status'], $_GET['period_id'], $_GET['bptz17'], $_GET['bptz17_25'], $_GET['bptz25'], $_GET['bptzAll'], $_GET['attended17'], $_GET['attended17_25'], $_GET['attended25'], $_GET['attendedAll'], $_GET['lt_MeetingAverage'], $_GET['archive'], $_GET['comment'], $_GET['statisticCompleteChkbox'], $_GET['id_statistic'])]);
    exit();
    //$_GET['period_date'],
}
