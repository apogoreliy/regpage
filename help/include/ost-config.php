...
define('SECRET_SALT','C83B84F5CA6F9A7');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','rudanok@yandex.ru');

#Mysql Login info
define('DBTYPE','mysql');
define('DBHOST','localhost'); 
define('DBNAME','regpager_help');
define('DBUSER','regpager_help');
define('DBPASS','ZfU5IWnluBrp');
